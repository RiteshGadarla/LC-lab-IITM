                            ...
                            >
                                ...
                                <div className={`space-y-8 ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                                    <div className="space-y-4">
                                        ...
                                        <h3 className="text-3xl md:text-4xl font-bold text-slate-900 leading-tight text-center lg:text-left">
                                            {event.heading}
                                        </h3>
                                    </div>
                                    ...
                                    <div className="bg-slate-50 border-l-4 border-[#000080] p-6 rounded-r-lg space-y-3">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <span
                                                    className="block text-sm font-semibold text-slate-500 uppercase tracking-wide">Date</span>
                                        ...
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                <span
                                                    className="block text-sm font-semibold text-slate-500 uppercase tracking-wide">Venue</span>
                                                <span
                                                    className="text-lg text-slate-900 font-medium">{event.venue}</span>
                                            </div>
                                        </div>
                                    </div>
